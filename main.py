...
# activar en entorno:  .venv\Scripts\activate
...
class Precios:
    ...
    def logeado(self):
        ...
        print(Fore.LIGHTGREEN_EX + "=" * 25 + Fore.WHITE)

        for id, estado, precio in con.sql_select_all("precios"):
        ...
        while self.menu_seleccion:
            ...
            try:
                ...
                print("Parece que pusiste un número, intentalo otra veZ.")
    ...
    def init_sesion(self):
        ...
        print("Por favor, introduce tu contraseña. ejemplo:juan")
        intentos = 0
...
def Main():
    ...
    while True:
        ...
        print(Fore.LIGHTWHITE_EX + "i" + Fore.WHITE," - " + Fore.RED + "I" + Fore.WHITE + "nformación precios")
        print(Fore.LIGHTWHITE_EX + "s" + Fore.WHITE," - " + Fore.RED + "S" + Fore.WHITE + "alir de la aplicación")
